...
export const Route = createFileRoute("/_authenticated/admin/errors")({
  head: () => ({
    meta: [
      { title: "Error Reports — Niza Prime AI" },
      { name: "description", content: "Administrator view of automatic Niza Prime AI error reports." },
      { property: "og:title", content: "Error Reports — Niza Prime AI" },
      { property: "og:description", content: "Administrator view of automatic Niza Prime AI error reports." },
